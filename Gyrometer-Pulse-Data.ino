...
void loop() { 
  ...
  //Serial.print(" , ");
  heartRateFxn(terrainCoord);
  //Serial.print(terrainCoord[1]);
  //Serial.print(" , ");
  terrainCoord[1] = terrainCoord[1] * amplitude;
  //Serial.println(terrainCoord[1]);
  terrainCoord[1]= map(terrainCoord[1], 0, 2000, 0, WindowsAppHeight);
  Serial.println(terrainCoord[1]);
  //Serial.print(" , ");
}
